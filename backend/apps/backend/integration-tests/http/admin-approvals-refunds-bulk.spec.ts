...
// Duplicated bootstrapAdmin helper from admin-audit-log.spec.ts /
// admin-staff-capabilities.spec.ts — extraction into a shared file is a
// separate follow-up. Keep it verbatim for now.
