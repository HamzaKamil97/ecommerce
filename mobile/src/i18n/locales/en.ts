export const en = {
  ...
  'games.hubTitle': 'While you wait',
  'games.hubSubtitle': 'Light moments from Najma — free, cosmetic, just for fun',
  'games.menuLabel': 'Wait-games',
  'games.entryTitle': 'Play while you wait?',
  'games.entrySubtitle': 'Najma has a few light moments for you',
  'games.entryAction': 'Open games',
  'games.play': 'Play',
  'games.comingSoon': 'Coming soon',
  'games.back': 'Back',

  // Souk Wheel
  'games.soukWheel.name': 'Souk Wheel',
  'games.soukWheel.tagline': 'Spin for a kind word from Najma',
  'games.soukWheel.spin': 'Spin',
  'games.soukWheel.spinAgain': 'Spin again',
  'games.soukWheel.back': 'Back to games',
  'games.soukWheel.phrase1': 'Mashallah! 🌹',
  'games.soukWheel.phrase2': 'Nice pick! ✨',
  'games.soukWheel.phrase3': 'You have great taste 👑',
  'games.soukWheel.phrase4': 'Beautiful! 💎',
  'games.soukWheel.phrase5': 'Marhaba 🌟',
  'games.soukWheel.phrase6': 'Bravo! 🎉',
  'games.soukWheel.phrase7': 'Sweet! 🍬',
  'games.soukWheel.phrase8': 'Wow! 🪄',

  // Recipe of the Day
  'games.recipe.name': 'Recipe of the Day',
  'games.recipe.tagline': 'Najma picks one Iraqi recipe per day',
  'games.recipe.cookAnother': 'Show another',
  'games.recipe.bylineFmt': 'Shared by Najma · {date}',
  'games.recipe.ingredients': 'Ingredients',
  'games.recipe.steps': 'Steps',
  'games.recipe.prepMin': '{min} min',
  'games.recipe.quzi.name': 'Quzi',
  'games.recipe.quzi.region': 'Baghdad',
  'games.recipe.masgouf.name': 'Masgouf',
  'games.recipe.masgouf.region': 'Tigris River',
  'games.recipe.dolma.name': 'Dolma',
  'games.recipe.dolma.region': 'All Iraq',
  'games.recipe.kubba.name': 'Kubba Hamadh',
  'games.recipe.kubba.region': 'Mosul',
  'games.recipe.lentil.name': 'Lentil Soup',
  'games.recipe.lentil.region': 'All Iraq',

  // Coming-soon games
  'games.chefsRace.name': "Chef's Race",
  'games.chefsRace.comingSoon': 'Watch local chefs cook in real time',
  'games.guessPrice.name': 'Guess the Price',
  'games.guessPrice.comingSoon': 'Guess the price of a hidden item',
  'games.predictArrival.name': 'Predict Arrival',
  'games.predictArrival.comingSoon': "Predict your courier's exact arrival",
  'games.soukStories.name': 'Souk Stories',
  'games.soukStories.comingSoon': 'Short tales from shops around Iraq',
  'games.voiceMemo.name': 'Voice Memo',
  'games.voiceMemo.comingSoon': 'Send a voice note to your shop',
  'games.prepAlong.name': 'Prep Along',
  'games.prepAlong.comingSoon': 'Najma cooks with you, step by step',
  'games.playlist.name': 'Hanoot Playlist',
  'games.playlist.comingSoon': 'Music while your order arrives',

  // A-Re9 — Coming Soon locks for multi-user / gift / seasonal features
  'account.moreFeatures': 'More features',
  'comingSoon.groupGift.title': 'Group Gift',
  'comingSoon.groupGift.subtitle': 'Collect contributions from friends — one beautiful gift at the end.',
  'comingSoon.weddingRegistry.title': 'Wedding Registry',
  'comingSoon.weddingRegistry.subtitle': "Build a list. Share with guests. Track what's been picked.",
  'comingSoon.refer.title': 'Refer a friend',
  'comingSoon.refer.subtitle': 'Earn credit when friends order with your link.',
  'comingSoon.giftOccasions.title': 'Gift Occasions',
  'comingSoon.giftOccasions.subtitle': 'Curated baskets for birthdays, weddings, new-baby, condolences.',
  'comingSoon.familyShopping.title': 'Family Shopping',
  'comingSoon.familyShopping.subtitle': 'A shared cart for the whole household. Everyone adds, one delivery.',
  'comingSoon.seasonal.title': 'Seasonal',
  'comingSoon.seasonal.subtitle': "Ramadan, Eid, summer harvests — what's special right now.",
  'comingSoon.special.title': 'Special Collections',
  'comingSoon.special.subtitle': 'Curated boxes — premium, limited, hand-picked by Najma.',
  'comingSoon.concierge.title': 'Personal Concierge',
  'comingSoon.concierge.subtitle': 'A real human shopper, on-call — your Hanoot Khass perk.',
  'product.sendAsGift': 'Send as a gift',
  'pass.previewConcierge': 'Preview the concierge experience',

  // A-Re9 — locked.* keys (current spec)
  'locked.menuGroupTitle': 'More from Hanoot',
  'locked.comingSoon': 'Coming soon',
  'locked.groupGift.title': 'Group Gift',
  'locked.groupGift.subtitle': 'Pool money with friends and gift together. Najma handles the rest.',
  'locked.weddingRegistry.title': 'Wedding Registry',
  'locked.weddingRegistry.subtitle': 'Build a registry. Guests pick gifts. You get them on the big day.',
  'locked.refer.title': 'Refer a Friend',
  'locked.refer.subtitle': 'You both get credit on your first order together.',
  'locked.giftOccasions.title': 'Gift Occasions',
  'locked.giftOccasions.subtitle': 'Birthdays, weddings, Eid, just-because — Najma builds the gift basket.',
  'locked.giftOccasions.cartHint': 'Make this a gift?',
  'locked.family.title': 'Family Shopping',
  'locked.family.subtitle': 'Shared family list. Anyone in the family can add. One delivery.',
  'locked.seasonal.title': 'Seasonal Collections',
  'locked.seasonal.subtitle': 'Ramadan baskets, Eid spreads, summer picks — curated by Najma.',
  'locked.special.title': 'Curated Boxes',
  'locked.special.subtitle': 'Hand-picked boxes around a theme. Iraqi pantry, Baghdad breakfast, Erbil pastry.',
  'locked.concierge.title': 'Hanoot Concierge',
  'locked.concierge.subtitle': 'A human concierge for Khass members. Layan, in your pocket.',
} as const;
